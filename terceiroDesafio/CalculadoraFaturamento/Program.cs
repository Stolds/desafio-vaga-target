...
namespace CalculadoraFaturamento

{
    ...
    },
    {
        ...
        ""valor"": 8414.61
            ...
            var menorValor = dados.Where(d => d.Valor > 0).Min(d => d.Valor);
            var maiorValor = dados.Max(d => d.Valor);

            var culturaBr = new CultureInfo("pt-BR");

            Console.WriteLine($"Menor valor de faturamento diário: {menorValor.ToString("C2", culturaBr)}");
            Console.WriteLine($"Maior valor de faturamento diário: {maiorValor.ToString("C2", culturaBr)}");
